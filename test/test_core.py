...
def test_filter_run_dict():
    filter = MultiplyFilter(name="multiply", default_params={"add": 0, "scalar": 2})
    img = [[1, 2, 3], [4, 5, 6]]
...
def test_filter_apply():
    filter = MultiplyFilter(name="multiply", default_params={"add": 0, "scalar": 1})
    img = [[1, 2, 3], [4, 5, 6]]
